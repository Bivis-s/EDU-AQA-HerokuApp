...
public class DataTablesTest extends AbstractTest {
    ...
    public void table1THeadSizeTest() {
        ...
        Assert.assertEquals(
                dataTablesPage.getTable1HeadSize(),
                Values.TABLE1_THEAD_SIZE);
    }
    ...
    public void table1RowsCountTest() {
        ...
        Assert.assertEquals(
                dataTablesPage.getTable1TBodyRowsSize(),
                Values.TABLE1_ROWS_SIZE);
    }
    ...
    public void table1Body1stRowColumnsCountTest() {
        ...
        Assert.assertEquals(
                dataTablesPage.getTable1Body1stRowCellsSize(),
                Values.TABLE1_1ST_ROW_COLUMNS_SIZE);
    }
    ...
    public void table1THeadContentTest() {
        ...
        for (int i = 0; i < rowsSize; i++) {
            Assert.assertEquals(
                    dataTablesPage.getTable1HeadCell(i + 1),
                    Values.TABLE1_THEADS[i]);
        }
    ...
    public void table1TBodyContentTest() {
        ...
        for (int i = 0; i < rowsSize; i++) {
            for (int j = 0; j < columnsSize; j++) {
                Assert.assertEquals(
                        dataTablesPage.getTable1TbodyCell(i + 1, j + 1),
                        Values.TABLE1_TBODYS[i][j]);
            }
        }
    }
